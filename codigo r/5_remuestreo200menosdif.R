...
prueba <- data.frame(sexo = rep(c("hombre", "mujer"), each = 200))
num_preguntas <- 22
...
for (i in 1:num_preguntas) {
  ...
  n_respuestas_por_categoria_hombres <- round(200 * proporciones$prop[inicio_hombres:fin_hombres])
  n_respuestas_por_categoria_mujeres <- round(200 * proporciones$prop[inicio_mujeres:fin_mujeres])
  ...
  respuestas_hombres <- ajustar_longitud_respuestas(respuestas_hombres, 200)
  respuestas_mujeres <- ajustar_longitud_respuestas(respuestas_mujeres, 200)
...
save(modelo_P1, modelo_P2, modelo_P3, modelo_P4, modelo_P5, modelo_P6, modelo_P7, modelo_P8, modelo_P9, modelo_P10, modelo_P11, modelo_P12, modelo_P13, modelo_P14, modelo_P15, modelo_P16, modelo_P17, modelo_P18, modelo_P19, modelo_P20, modelo_P21, modelo_P22, file = "modelos_brms_remuestreo3.RData")

load("modelos_brms_remuestreo3.RData")
